        ...
        return (
          <SafeAreaView style={styles.wrapper}>
            ...
            <ScrollView>
                   ...
                   <Text style={{  textAlign: 'center', fontSize: wp('4%'),paddingBottom:wp('4%') }}>Thank You for your registration, one of our team members will review your details and will grant access with in 12-24 hours.</Text>
