    ...
    return (
      ...
      <SafeAreaView style={styles.wrapper}>
        <View style={{alignItems:'center',backgroundColor:'white'}}>
                  ...
                  <TouchableOpacity onPress={()=>this.props.navigation.navigate('FavouriteVedioList')}>
                  <Image
                  ...
                  <TouchableOpacity onPress={()=>this.props.navigation.navigate('FavouriteDocumentList')}>
                  <Image
